document.addEventListener("DOMContentLoaded", function () {
    ...
    const musicData = [
        ...
        },
        {
            ...
            producer: "Delta",
            genre: "Hip-hop",
            file: "Lucky for now by Delta.mp3",
            artwork: "none.jpg",
            trending:"no"
        },
        {
            title: "umandimvesa kukoma",
            artist: "Nsikizi Family",
            album: "none",
            release: "2021-10-28",
            duration: "3:17",
            producer: "Kedo ki zanyimbo adha",
            genre: "Pasada",
            file: "umandmvesa kukoma by Nsikizi family ft chowinila.mp3",
            artwork: "none.jpg",
            trending:"no"
        },
            {
